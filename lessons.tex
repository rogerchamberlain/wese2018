...
% TODO: BSIEVER:  Add content / lessons

% TODO: Does reporting student eval comments and/or scores require IRB approval (well, IRB stamp of "exempt")?
...
% FIXME: Self-selection bias rather than impact of the extra questions....  You could see if the same group had comparable stats for Exam 1 & 2 (where the problems done later in the semester indicate students who "go above and beyond", but clearly had no impact on the exam scores)
